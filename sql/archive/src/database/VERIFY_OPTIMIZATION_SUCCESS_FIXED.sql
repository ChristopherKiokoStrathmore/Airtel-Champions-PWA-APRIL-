-- ============================================================================
-- VERIFICATION SCRIPT - FIXED VERSION (No Errors)
-- ============================================================================
...
-- ============================================================================
-- 📊 STEP 4: COMPARE DATABASE SIZE (FIXED)
-- ============================================================================
...
-- Check total size of all tables
SELECT 
    pg_size_pretty(SUM(pg_total_relation_size(quote_ident(schemaname) || '.' || quote_ident(tablename)))) AS all_tables_size
FROM pg_tables
WHERE schemaname = 'public';

-- Check total size of all indexes
SELECT 
    pg_size_pretty(SUM(pg_relation_size(indexname::regclass))) AS all_indexes_size
FROM pg_indexes
WHERE schemaname = 'public';
...
-- ============================================================================
-- 🎯 DETAILED TABLE SIZES (BONUS)
-- ============================================================================

-- See sizes of all your tables
SELECT 
    tablename,
...
-- This shows which tables are largest and their index overhead
